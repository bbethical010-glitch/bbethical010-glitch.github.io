export function Screenshots() {
  ...
  return (
    <section className="py-20 px-0 border-t-4 border-purple bg-bg overflow-hidden">
      <div className="px-4 max-w-7xl mx-auto mb-12 text-center">
        <h2 className="font-anton text-5xl text-text uppercase">What It Looks Like</h2>
      </div>
        ...
        {screenshots.map((title, idx) => (
          ...
          >
            <div className="w-full aspect-[1/2] bg-[#1c1b1b]">
              {/* Replace placeholder URLs with actual app screenshots */}
              <img 
                src={`https://via.placeholder.com/200x400/1c1b1b/9b30ff?text=${title.toUpperCase().replace(' ', '+')}`} 
